...
router.get("/recetas", verifyToken, (req, res) => {
 recetaSchema.find()
 .then((data) => res.json(data))
 .catch((error) => res.json({ message: error }));
});
// Ruta para obtener las recetas con la calificación más alta
router.get("/reportes/top-recetas", verifyToken, async (req, res) => {
  try {
...
router.get("/recetas/buscar", verifyToken, (req, res) => {
...
router.get("/recetas/:id", verifyToken, (req, res) => {
 const { id } = req.params;
 recetaSchema
 .findById(id)
 .then((data) => res.json(data))
...
router.put("/recetas/:id/modificar", verifyToken, (req, res) => {
 const { id } = req.params;
...
router.patch("/recetas/:id/publicar", verifyToken, async (req, res) => {
  try {
    const { id } = req.params;
